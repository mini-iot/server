  ...
  <div id="content" style="display: block;">
    <div id="chooser" style="display: block">
      ...
      <div id="theloginform" style="display: block;">
        <form name="login" method="post" id="login_form" onsubmit="" action="/user/singup">
          <div id="usernamegroup" class="inputgroup">
            <label for="username" class="label usernamelabel">帐号</label>
          ...
          <label for="password2" class="label">再次确认</label>
          <input class="input r4 wide mb16 mt8 password" type="password" id="password2" name="pwd2" onkeypress="" autocomplete="off">
          <input class="button r4 wide primary" type="submit" id="Login" name="Login" value="注册">
        </form>
      </div>
    </div></div>
    <div id="signup" class="tc mt24" style="display: block;"><p class="di mr16">已经有帐号了？</p><a class="button secondary" id="signup_link" href="/user/singin">立刻登录</a></div>
  </div></div></div>
